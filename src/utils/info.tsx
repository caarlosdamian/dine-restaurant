...
export const menuInfo = [
  {
    ...
    images: [
      '/images/homepage/salmon-mobile.jpg',
      '/images/homepage/salmon-desktop-tablet.jpg',
      '/images/homepage/salmon-desktop-tablet.jpg',
    ],
  },
  {
    ...
    images: [
      '/images/homepage/beef-mobile.jpg',
      '/images/homepage/beef-desktop-tablet.jpg',
      '/images/homepage/beef-desktop-tablet.jpg',
    ],
  },
  {
    ...
    images: [
      '/images/homepage/chocolate-mobile.jpg',
